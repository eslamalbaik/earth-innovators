...
export default function AdminStoreRewardsEdit({ reward }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        requires_manual_approval: reward?.requires_manual_approval ?? false,
    });

    const submit = (e) => {
        e.preventDefault();
        put(route('admin.store-rewards.update', reward.id));
    };

    return (
        <DashboardLayout header={t('adminStoreRewardsPage.editTitle')}>
            <Head title={t('adminStoreRewardsPage.editPageTitle', { appName: t('common.appName') })} />
