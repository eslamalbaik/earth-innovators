...
export default function AdminCategoriesCreate() {
    ...
    return (
        <DashboardLayout>
            <Head title={t('adminCategoriesPage.createPageTitle', { appName: t('common.appName') })} />
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-6">
                        <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
                            ...
                            <span className="text-gray-900">{t('adminCategoriesPage.createTitle')}</span>
                        </div>
                        <h1 className="text-2xl font-bold text-gray-900">
                            {t('adminCategoriesPage.createTitle')}
                        </h1>
                        <p className="mt-1 text-sm text-gray-600">
                            {t('adminCategoriesPage.createSubtitle')}
                        </p>
                    </div>
