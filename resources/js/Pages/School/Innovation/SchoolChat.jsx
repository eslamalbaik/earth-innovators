...
const SUGGESTION_CHIPS = [
    ...
    { label: 'أضعف المؤشرات', question: 'ما هي أضعف المؤشرات على مستوى طلاب مدرستي وكيف يمكن تحسينها؟' },
    { label: 'الطلاب المتميزون', question: 'من هم طلاب مدرستي الأعلى أداءً وما هي تصنيفاتهم؟' },
    { label: 'طلاب يحتاجون اهتماماً', question: 'من هم طلاب مدرستي الذين يحتاجون لاهتمام خاص ولماذا؟' },
    { label: 'توزيع التصنيفات', question: 'كيف يتوزع طلاب مدرستي على التصنيفات المختلفة (ماسي، بلاتيني، ذهبي...)؟' },
    { label: 'مقارنة المؤشرات', question: 'قارن بين متوسطات المؤشرات الثمانية لطلاب مدرستي وحدد أقوى وأضعف مؤشر' },
];
...
export default function SchoolChat() {
    ...
    const sendMessage = async (question = null) => {
        ...
        try {
            const response = await axios.post(route('school.innovation.chat.ask'), { question: text });
            const aiMsg = {
                role: 'assistant',
    ...
    return (
        <DashboardLayout header="الوكيل الذكي">
            <Head title="الوكيل الذكي — مساعد المدرسة" />
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50/50">
                        {messages.length === 0 ? (
                            <div className="h-full flex flex-col items-center justify-center text-center py-8">
                                ...
                                <p className="text-xs text-gray-400 max-w-sm mb-6">اسألني أي سؤال عن بيانات طلاب مدرستك أو مؤشرات الابتكار أو التصنيفات وسأجيبك فوراً.</p>
