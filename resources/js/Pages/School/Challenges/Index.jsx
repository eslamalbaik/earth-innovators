...
import { FaTrophy, FaPlus, FaCalendar, FaEye, FaEdit, FaTrash, FaUsers, FaCheckCircle, FaTimes } from 'react-icons/fa';
import { useState, useEffect } from 'react';

export default function SchoolChallengesIndex({ auth, challenges, stats, filters }) {
    ...
    const handleDelete = (challengeId) => {
        if (confirm('هل أنت متأكد من حذف هذا التحدي؟')) {
            ...
            router.delete(`/school/challenges/${challengeId}`, {
                preserveScroll: true,
    ...
    return (
        <DashboardLayout
            auth={auth}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">تحديات المدرسة</h2>}
        >
            <Head title="تحديات المدرسة - لوحة المدرسة" />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        <div className="bg-white rounded-lg shadow p-4">
                            <div className="text-gray-600 text-sm mb-1">إجمالي التحديات</div>
                            <div className="text-2xl font-bold text-gray-900">{stats?.total || 0}</div>
                        </div>
                        <div className="bg-white rounded-lg shadow p-4">
                            <div className="text-gray-600 text-sm mb-1">نشط</div>
