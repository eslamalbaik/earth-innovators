...
export default function SchoolChallengeSubmissionShow({ auth, submission, availableBadges }) {
    ...
    const statusLabel = (status) => {
        if (status === 'submitted') return t('schoolChallengeSubmissionShowPage.statusSubmitted');
        if (status === 'reviewed') return t('schoolChallengeSubmissionShowPage.statusReviewed');
        if (status === 'approved') return t('schoolChallengeSubmissionShowPage.statusApproved');
        if (status === 'rejected') return t('schoolChallengeSubmissionShowPage.statusRejected');
        return status;
    };

    return (
        <DashboardLayout auth={auth}>
            <Head title={t('schoolChallengeSubmissionShowPage.pageTitle', { title: submission.challenge?.title })} />

            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <Link
                    href={`/school/challenge-submissions?challenge_id=${submission.challenge_id}`}
                                ...
                                <div className="flex items-center gap-2 text-gray-600">
                                    ...
                                    <span className="font-medium">
                                        {t('schoolChallengeSubmissionShowPage.studentLabel', {
                                            name: submission.student?.name || t('common.notAvailable'),
                                        })}
                                    </span>
                                </div>
                                <div className="flex items-center gap-2 text-gray-600">
                                    ...
                                    <span>
                                        {t('schoolChallengeSubmissionShowPage.submissionDateLabel', {
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        ...
                                        <span className="ms-2 text-gray-600">
                                            {t('schoolChallengeSubmissionShowPage.ratingValue', { rating })}
                                        </span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            <p className="font-medium text-gray-900">
                                                {t('schoolChallengeSubmissionShowPage.ratingValue', { rating: submission.rating })}
                                            </p>
                                        </div>
                                    </div>
                                )}
                                {submission.points_earned > 0 && (
                                    <div>
                                        ...
                                        <p className="font-medium text-green-600">
                                            {t('schoolChallengeSubmissionShowPage.pointsValue', { points: submission.points_earned })}
                                        </p>
                                    </div>
                                )}
