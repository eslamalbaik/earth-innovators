                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        {!auth?.user && (
                            <div className="hidden md:flex justify-end items-center gap-2">
                                <Link
                                    href="/register"
                                    className="text-sm bg-white hover:bg-gray-100 text-legacy-green px-4 py-2 rounded-lg font-semibold transition duration-300 flex items-center space-x-1 space-x-reverse shadow-md"
                                >
                                ...
                                <div className="relative">
                                    ...
                                    {userMenuOpen && (
                                        <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg py-2 z-50">
                                            ...
                                            <button onClick={handleLogout} className="w-full text-right px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2">
                                                <FaSignOutAlt /> خروج
                                            </button>
                                        </div>
                                    )}
                        ...
                        <div className="md:hidden border-t border-white/20 py-4">
                            <div className="flex flex-col space-y-4">
                                ...
                                <div className="border-t border-white/20 pt-2">
                                    <Link
                                        href="/register"
                                        className="block bg-white hover:bg-gray-100 text-legacy-green px-6 py-3 rounded-lg font-semibold text-center transition duration-300 shadow-md"
                                        onClick={() => setIsMobileMenuOpen(false)}
                                    >
                                        انضم للمنصة
                                    </Link>
