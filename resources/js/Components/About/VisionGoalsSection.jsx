...
export default function VisionGoalsSection() {
    const goals = [
        ...
        "إصدار الشهادات للمدارس والطلاب المتميزين",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="text-right bg-white shadow-xl border border-gray-200 rounded-3xl p-6">
                ...
                <p className="text-lg text-gray-800 leading-relaxed">
                    أن نكون المنصة التعليمية الرائدة في المنطقة التي تبني مجتمعاً من المبتكرين والموهوبين في المدارس، من خلال توفير بيئة محفزة للإبداع والابتكار، وربط الطلاب المبتكرين مع المعلمين والمشرفين، وتنظيم التحديات والمسابقات التعليمية المثيرة.
                </p>
            </div>
