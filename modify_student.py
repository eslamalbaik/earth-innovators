...
with open("resources/js/Pages/Student/Certificate/Show.jsx", "r", encoding="utf-8") as f:
    content = f.read()
...
with open("resources/js/Pages/Student/Certificate/Show.jsx", "w", encoding="utf-8") as f:
    f.write(content)
print("Done")
