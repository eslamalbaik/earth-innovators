        ...
        try {
            $aiResponse = $deepSeekClient->chatWithJson([
                \App\Services\AIEngine\GeminiClient::systemMessage(
                    ...
                    . 'اقترح أيضاً عبارة بحث دقيقة من 3 إلى 5 كلمات وصفية باللغة الإنجليزية تصف بالتحديد المشهد البصري لهذا المشروع تحديداً (وليست كلمة عامة مثل innovation أو education)، لاستخدامها في البحث عن صورة غلاف مطابقة من Unsplash. '
