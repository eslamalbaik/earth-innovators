        ...
        try {
            $aiResponse = $client->chatWithJson([
                GeminiClient::systemMessage(
                    ...
                    . 'اقترح أيضاً رمزاً تعبيرياً واحداً (emoji) مناسباً للشارة، وعبارة بحث دقيقة من 3 إلى 5 كلمات وصفية بالإنجليزية تصف بالتحديد المشهد البصري المرتبط بفكرة هذه الشارة تحديداً (وليست كلمة عامة مثل achievement أو badge)، لاستخدامها في البحث عن صورة مطابقة على Unsplash. '
                    ...
                    . 'image_keyword (عبارة بحث دقيقة من 3 إلى 5 كلمات وصفية بالإنجليزية خاصة بمحتوى هذه الشارة تحديداً، وليست كلمة عامة).'
                ),
