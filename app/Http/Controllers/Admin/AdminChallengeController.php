        ...
        try {
            $aiResponse = $deepSeekClient->chatWithJson([
                \App\Services\AIEngine\GeminiClient::systemMessage(
                    ...
                    . 'اقترح أيضاً عبارة بحث دقيقة من 3 إلى 5 كلمات وصفية باللغة الإنجليزية تصف بالتحديد المشهد البصري لهذا التحدي تحديداً (وليست كلمة عامة مثل challenge أو education)، لاستخدامها في البحث عن صورة غلاف مطابقة من Unsplash. '
                    ...
                    . 'image_keyword (عبارة بحث دقيقة من 3 إلى 5 كلمات وصفية بالإنجليزية خاصة بمحتوى هذا التحدي تحديداً، وليست كلمة عامة), '
