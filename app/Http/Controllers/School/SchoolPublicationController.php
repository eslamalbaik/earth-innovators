        ...
        try {
            $aiResponse = $deepSeekClient->chatWithJson([
                \App\Services\AIEngine\GeminiClient::systemMessage(
                    ...
                    . 'بالإضافة لذلك، قم باقتراح عبارة بحث دقيقة من 3 إلى 5 كلمات وصفية باللغة الإنجليزية تصف بالتحديد المشهد البصري المرتبط بموضوع هذا المقال تحديداً (وليست كلمة عامة مثل education)، لاستخدامها في البحث عن صورة مطابقة على موقع Unsplash. '
                    ...
                    . 'image_keyword (عبارة بحث دقيقة من 3 إلى 5 كلمات وصفية بالإنجليزية خاصة بموضوع هذا المقال تحديداً، وليست كلمة عامة، للبحث في Unsplash).'
                ),
